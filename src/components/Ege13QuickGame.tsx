...
import { ArrowLeft, ArrowRight, BookOpenCheck, Copy, Trophy, X } from 'lucide-react';
        ...
        {status === 'offer' && !isInspectMode && (
          <div className="p-5 sm:p-6">
            <div className="mb-5 flex items-start gap-3 pr-10">
              ...
              <div>
                <h2 className="text-xl font-black leading-tight text-foreground">Тип 13 быстро</h2>
                <p className="mt-1 max-w-[38ch] text-pretty text-sm leading-5 text-foreground/65">
                  Выбери, как раскрывается НЕ или НИ в&nbsp;коротком контексте.
                </p>
              </div>
            </div>
        ...
        {status === 'finished' && (
          <div className="p-5 sm:p-6">
            <div className="mb-5 flex items-center gap-3 pr-10">
              ...
              <div>
                <h2 className="text-xl font-black leading-tight text-foreground">Тип 13 завершён</h2>
