        ...
        {status === 'running' && currentCard && (
          <div className="flex flex-1 flex-col p-3 sm:p-5">
            <div className="mb-3 grid grid-cols-[1fr_auto] items-center gap-2 pr-9 sm:mb-4 sm:pr-10">
              {combo > 0 && (
                <div className="rounded-full bg-emerald-50 px-2.5 py-1 text-xs font-black text-emerald-700 ring-1 ring-emerald-200 dark:bg-emerald-500/10 dark:text-emerald-200 dark:ring-emerald-500/20 sm:px-3 sm:text-sm">
                  x{combo}
                </div>
              )}
              {!combo && <div />}
              <div className="justify-self-end rounded-full bg-sky-50 px-2.5 py-1 text-xs font-black text-sky-700 ring-1 ring-sky-200 dark:bg-sky-500/10 dark:text-sky-200 dark:ring-sky-500/20 sm:px-3 sm:text-sm">
                {scoreDelta}
              </div>
            </div>
